...
namespace Repositorio.Migrations
{
    ...
    [Migration("20250204231121_campoNombreGrupo")]
    partial class campoNombreGrupo
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Dominio.Familias.Grupo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Dominio.Familias.Grupo", b =>
                {
                    b.HasOne("Dominio.Usuarios.Usuario", "UsuarioAdministrador")
                        .WithOne()
                        .HasForeignKey("Dominio.Familias.Grupo", "UsuarioAdministradorId")
            ...
            modelBuilder.Entity("Dominio.Usuarios.Usuario", b =>
                {
                    b.HasOne("Dominio.Familias.Grupo", "GrupoDeGastos")
                        .WithMany("MiembrosGrupoGasto")
                        .HasForeignKey("GrupoDeGastosId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.Navigation("GrupoDeGastos");
                });
            ...
            modelBuilder.Entity("Dominio.Familias.Grupo", b =>
                {
                    b.Navigation("MiembrosGrupoGasto");
